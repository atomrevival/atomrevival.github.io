...
},{}],"8T80n":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "75d86e05ec275ff7";
...
},{}],"d0Zf9":[function(require,module,exports) {
...
const App = ()=>{
    const featureRouter = new (0, _index.GraphRouter)();
    console.log("started");
    featureRouter.graph = [
        {
            path: "1/12",
    ...
    console.log(featureRouter.graph);
...
},{"react/jsx-dev-runtime":"iTorj","react":"21dqq","../../../src/index":"2YKLe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"km3Ru"}],"iTorj":[function(require,module,exports) {
"use strict";
...
},{}],"2YKLe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "GraphRouter", ()=>GraphRouter);
...
class GraphRouter {
    ...
    paths = [];
    // Private
    #graph = new (0, _graphologyDefault.default)();
    generateGraph = ()=>{
...
},{"graphology":"l0nzg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l0nzg":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    "use strict";
    ...
    function l(t) {
        return !!d(t) && !(t.attributes && !Array.isArray(t.attributes));
    }
    ...
    var j = N, O = {};
    O.ARRAY_BUFFER_SUPPORT = "undefined" != typeof ArrayBuffer, O.SYMBOL_SUPPORT = "undefined" != typeof Symbol;
    var C = j, z = O, M = z.ARRAY_BUFFER_SUPPORT, W = z.SYMBOL_SUPPORT;
    var P = function(t) {
        var e = function(t) {
            return "string" == typeof t || Array.isArray(t) || M && ArrayBuffer.isView(t) ? C.fromSequence(t) : "object" != typeof t || null === t ? null : W && "function" == typeof t[Symbol.iterator] ? t[Symbol.iterator]() : "function" == typeof t.next ? t : null;
        }(t);
    ...
    function H(t, e, n, r, i, o, a) {
        var u, c, s, d;
        if (r = "" + r, 0 === n) {
            if (!(u = t._nodes.get(r))) throw new F("Graph.".concat(e, ': could not find the "').concat(r, '" node in the graph.'));
            s = i, d = o;
        } else if (3 === n) {
            if (i = "" + i, !(c = t._edges.get(i))) throw new F("Graph.".concat(e, ': could not find the "').concat(i, '" edge in the graph.'));
            ...
            if (!(c = t._edges.get(r))) throw new F("Graph.".concat(e, ': could not find the "').concat(r, '" edge in the graph.'));
    ...
    var Q = [
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i) {
                    var o = H(this, e, n, t, r, i), a = o[0], u = o[1];
        ...
        },
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i, o) {
                    var a = H(this, e, n, t, r, i, o), u = a[0], c = a[1], s = a[2];
        ...
        },
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i, o) {
                    var a = H(this, e, n, t, r, i, o), u = a[0], c = a[1], s = a[2];
                    if ("function" != typeof s) throw new B("Graph.".concat(e, ": updater should be a function."));
        ...
        },
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i) {
                    var o = H(this, e, n, t, r, i), a = o[0], u = o[1];
                    if (!d(u)) throw new B("Graph.".concat(e, ": provided attributes are not a plain object."));
        ...
        },
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i) {
                    var o = H(this, e, n, t, r, i), a = o[0], u = o[1];
                    if ("function" != typeof u) throw new B("Graph.".concat(e, ": provided updater is not a function."));
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r) {
                    ...
                    if (arguments.length > 2) {
                        ...
                        var o = "" + t, a = "" + r;
                        if (r = arguments[2], !(i = s(this, o, a, n))) throw new F("Graph.".concat(e, ': could not find an edge for the given path ("').concat(o, '" - "').concat(a, '").'));
                    } else {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t) {
                    ...
                    if (arguments.length > 1) {
                        ...
                        if (!(r = s(this, i, o, n))) throw new F("Graph.".concat(e, ': could not find an edge for the given path ("').concat(i, '" - "').concat(o, '").'));
                    } else {
                        if ("mixed" !== n) throw new I("Graph.".concat(e, ": calling this method with only a key (vs. a source and target) does not make sense since an edge with this key could have the other type."));
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r, i) {
                    ...
                    if (arguments.length > 3) {
                        if (this.multi) throw new I("Graph.".concat(e, ": cannot use a {source,target} combo when asking about an edge's attributes in a MultiGraph since we cannot infer the one you want information about."));
                        var a = "" + t, u = "" + r;
                        if (r = arguments[2], i = arguments[3], !(o = s(this, a, u, n))) throw new F("Graph.".concat(e, ': could not find an edge for the given path ("').concat(a, '" - "').concat(u, '").'));
                    } else {
                        if ("mixed" !== n) throw new I("Graph.".concat(e, ": calling this method with only a key (vs. a source and target) does not make sense since an edge with this key could have the other type."));
        ...
        },
        {
            ...
            attacher: function(t, e, n) {
                t.prototype[e] = function(t, r) {
                    ...
                    if (!d(r)) throw new B("Graph.".concat(e, ": provided attributes are not a plain object."));
    ...
    function ut(t, e) {
        var n = t[e];
        return void 0 !== n.next ? new j(function() {
            if (!n) return {
                done: !0
            };
            var t = {
    ...
    function yt(t, e, n, r) {
        var i = j.empty();
        return "undirected" !== t && (void 0 !== n.in && "out" !== e && r in n.in && (i = tt(i, ut(n.in, r))), void 0 !== n.out && "in" !== e && r in n.out && (e || n.key !== r) && (i = tt(i, ut(n.out, r)))), "directed" !== t && void 0 !== n.undirected && r in n.undirected && (i = tt(i, ut(n.undirected, r))), i;
    }
    var wt = [
        {
            name: "neighbors",
    ...
    function Gt(t, e) {
        ...
        t.prototype[o] = function(t) {
            if ("mixed" !== r && "mixed" !== this.type && r !== this.type) return j.empty();
            t = "" + t;
            var e = this._nodes.get(t);
    ...
    function Et(t) {
        if (!d(t)) throw new B('Graph.import: invalid serialized node. A serialized node should be a plain object with at least a "key" property.');
        if (!("key" in t)) throw new B("Graph.import: serialized node is missing its key.");
        if ("attributes" in t && (!d(t.attributes) || null === t.attributes)) throw new B("Graph.import: invalid attributes. Attributes should be a plain object, null or omitted.");
    }
    function At(t) {
        if (!d(t)) throw new B('Graph.import: invalid serialized edge. A serialized edge should be a plain object with at least a "source" & "target" property.');
    ...
    var St, Dt = (St = 255 & Math.floor(256 * Math.random()), function() {
        return St++;
    }), Lt = new Set([
        "directed",
        "undirected",
    ...
    function Ot(t, e, n, r, i, o, a, u) {
        ...
        if (u && !d(u)) throw new B("Graph.".concat(e, ': invalid attributes. Expecting an object but got "').concat(u, '"'));
        if (o = "" + o, a = "" + a, u = u || {}, !t.allowSelfLoops && o === a) throw new I("Graph.".concat(e, ': source & target are the same ("').concat(o, "\"), thus creating a loop explicitly forbidden by this graph 'allowSelfLoops' option set to false."));
        var c = t._nodes.get(o), s = t._nodes.get(a);
        if (!c) throw new F("Graph.".concat(e, ': source node "').concat(o, '" not found.'));
        if (!s) throw new F("Graph.".concat(e, ': target node "').concat(a, '" not found.'));
        var h = {
            key: null,
            undirected: r,
            source: o,
        ...
        if (!t.multi && (r ? void 0 !== c.undirected[a] : void 0 !== c.out[a])) throw new I("Graph.".concat(e, ': an edge linking "').concat(o, '" to "').concat(a, "\" already exists. If you really want to add multiple edges linking those nodes, you should create a multi graph by using the 'multi' option."));
        var p = new V(r, i, c, s, u);
        t._edges.set(i, p);
        var f = o === a;
        return r ? (c.undirectedDegree++, s.undirectedDegree++, f && t._undirectedSelfLoopCount++) : (c.outDegree++, s.inDegree++, f && t._directedSelfLoopCount++), t.multi ? p.attachMulti() : p.attach(), r ? t._undirectedSize++ : t._directedSize++, h.key = i, t.emit("edgeAdded", h), i;
    }
    function Ct(t, e, n, r, i, o, a, u, s) {
        ...
        if (u) {
            if (s) {
                if ("function" != typeof u) throw new B("Graph.".concat(e, ': invalid updater function. Expecting a function but got "').concat(u, '"'));
            } else if (!d(u)) throw new B("Graph.".concat(e, ': invalid attributes. Expecting an object but got "').concat(u, '"'));
        }
        var h;
        if (o = "" + o, a = "" + a, s && (h = u, u = void 0), !t.allowSelfLoops && o === a) throw new I("Graph.".concat(e, ': source & target are the same ("').concat(o, "\"), thus creating a loop explicitly forbidden by this graph 'allowSelfLoops' option set to false."));
        ...
        var b = !1, m = !1;
        l || (l = jt(t, o, {}), b = !0, o === a && (g = l, m = !0)), g || (g = jt(t, a, {}), m = !0), p = new V(r, i, l, g, u), t._edges.set(i, p);
        var k = o === a;
    ...
    var Mt = function(n) {
        function r(t) {
            var e;
            if (e = n.call(this) || this, "boolean" != typeof (t = c({}, Nt, t)).multi) throw new B("Graph.constructor: invalid 'multi' option. Expecting a boolean but got \"".concat(t.multi, '".'));
            if (!Lt.has(t.type)) throw new B('Graph.constructor: invalid \'type\' option. Should be one of "mixed", "directed" or "undirected" but got "'.concat(t.type, '".'));
            ...
            return p(u(e), "_attributes", {}), p(u(e), "_nodes", new Map), p(u(e), "_edges", new Map), p(u(e), "_directedSize", 0), p(u(e), "_undirectedSize", 0), p(u(e), "_directedSelfLoopCount", 0), p(u(e), "_undirectedSelfLoopCount", 0), p(u(e), "_edgeKeyGenerator", function() {
                ...
                return t;
            }), p(u(e), "_options", t), Ut.forEach(function(t) {
                return p(u(e), t, e[t]);
            }), f(u(e), "order", function() {
                return e._nodes.size;
            }), f(u(e), "size", function() {
                return e._edges.size;
            }), f(u(e), "directedSize", function() {
                return e._directedSize;
            }), f(u(e), "undirectedSize", function() {
                return e._undirectedSize;
            }), f(u(e), "selfLoopCount", function() {
                return e._directedSelfLoopCount + e._undirectedSelfLoopCount;
            }), f(u(e), "directedSelfLoopCount", function() {
                return e._directedSelfLoopCount;
            }), f(u(e), "undirectedSelfLoopCount", function() {
                return e._undirectedSelfLoopCount;
            }), f(u(e), "multi", e._options.multi), f(u(e), "type", e._options.type), f(u(e), "allowSelfLoops", e._options.allowSelfLoops), f(u(e), "implementation", function() {
                return "graphology";
            }), e;
        }
        e(r, n);
        ...
        return i._resetInstanceCounters = function() {
            ...
            if (!n) throw new F('Graph.inboundDegreeWithoutSelfLoops: could not find the "'.concat(t, '" node in the graph.'));
            var r = 0, i = 0;
            ...
            t = "" + t;
            var e, n = this._nodes.get(t);
            if (!n) throw new F('Graph.outboundDegreeWithoutSelfLoops: could not find the "'.concat(t, '" node in the graph.'));
            var r = 0, i = 0;
            ...
            t = "" + t;
            var e, n = this._nodes.get(t);
            if (!n) throw new F('Graph.degreeWithoutSelfLoops: could not find the "'.concat(t, '" node in the graph.'));
            var r = 0, i = 0;
            ...
            var n = function(t, e, n) {
                if (n && !d(n)) throw new B('Graph.addNode: invalid attributes. Expecting an object but got "'.concat(n, '"'));
            ...
            if (e && !d(e)) throw new B('Graph.mergeNode: invalid attributes. Expecting an object but got "'.concat(e, '"'));
            t = "" + t, e = e || {};
            var n = this._nodes.get(t);
            ...
            if (arguments.length > 1) {
                ...
                if (!(e = s(this, n, r, this.type))) throw new F('Graph.dropEdge: could not find the "'.concat(n, '" -> "').concat(r, '" edge in the graph.'));
            ...
            if (!d(t)) throw new B("Graph.replaceAttributes: provided attributes are not a plain object.");
            return this._attributes = t, this.emit("attributesUpdated", {
                type: "replace",
                attributes: this._attributes
            }), this;
        }, i.mergeAttributes = function(t) {
            if (!d(t)) throw new B("Graph.mergeAttributes: provided attributes are not a plain object.");
            ...
            this._nodes.forEach(function(t, r) {
                e[n++] = function(t, e) {
                    ...
                    return h(e.attributes) || (n.attributes = c({}, e.attributes)), n;
                }(r, t);
            });
            ...
            return n = 0, this._edges.forEach(function(e, i) {
                r[n++] = function(t, e, n) {
                    ...
                    return h(n.attributes) || (r.attributes = c({}, n.attributes)), "mixed" === t && n.undirected && (r.undirected = !0), r;
                }(t.type, i, e);
            }), {
                options: {
                    type: this.type,
            ...
            var e, n, i, o, a, u = this, c = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
            if (t instanceof r) return t.forEachNode(function(t, e) {
                c ? u.mergeNode(t, e) : u.addNode(t, e);
            }), t.forEachEdge(function(t, e, n, r, i, o, a) {
                c ? a ? u.mergeUndirectedEdgeWithKey(t, n, r, e) : u.mergeDirectedEdgeWithKey(t, n, r, e) : a ? u.addUndirectedEdgeWithKey(t, n, r, e) : u.addDirectedEdgeWithKey(t, n, r, e);
            }), this;
            if (!d(t)) throw new B("Graph.import: invalid argument. Expecting a serialized graph or, alternatively, a Graph instance.");
            if (t.attributes) {
                if (!d(t.attributes)) throw new B("Graph.import: invalid attributes. Expecting a plain object.");
            ...
            if (t.nodes) {
                ...
                for(e = 0, n = i.length; e < n; e++){
                    Et(o = i[e]);
                    var s = o, h = s.key, p = s.attributes;
                    c ? this.mergeNode(h, p) : this.addNode(h, p);
                }
            }
            if (t.edges) {
                var f = !1;
                ...
                for(e = 0, n = i.length; e < n; e++){
                    ...
                    "key" in a ? (c ? b ? this.mergeUndirectedEdgeWithKey : this.mergeDirectedEdgeWithKey : b ? this.addUndirectedEdgeWithKey : this.addDirectedEdgeWithKey).call(this, a.key, g, y, w) : (c ? b ? this.mergeUndirectedEdge : this.mergeDirectedEdge : b ? this.addUndirectedEdge : this.addDirectedEdge).call(this, g, y, w);
                }
            }
            return this;
            ...
            for(var e, n, r = this.emptyCopy(t), i = this._edges.values(); !0 !== (e = i.next()).done;)Ot(r, "copy", !1, (n = e.value).undirected, n.key, n.source.key, n.target.key, c({}, n.attributes));
            return r;
        }, i.toJSON = function() {
            return this.export();
        }, i.toString = function() {
    ...
    "undefined" != typeof Symbol && (Mt.prototype[Symbol.for("nodejs.util.inspect.custom")] = Mt.prototype.inspect), [
        {
            name: function(t) {
        ...
        [
            ...
            var n = t.name(e), r = "add" === e ? Ot : Ct;
            t.generateKey ? Mt.prototype[n] = function(i, o, a) {
                return r(this, n, !0, "undirected" === (t.type || this.type), null, i, o, a, "update" === e);
            } : Mt.prototype[n] = function(i, o, a, u) {
        ...
        et.forEach(function(e) {
            !function(t, e) {
                ...
                t.prototype[n] = function(t, e) {
                    if ("mixed" !== r && "mixed" !== this.type && r !== this.type) return [];
                    if (!arguments.length) return ct(this, r);
                    if (1 === arguments.length) {
                        t = "" + t;
                ...
                t.prototype[o] = function(t, e, n) {
                    if ("mixed" === r || "mixed" === this.type || r === this.type) {
                        if (1 === arguments.length) return st(!1, this, r, n = t);
                        if (2 === arguments.length) {
                            t = "" + t, n = e;
                            var a = this._nodes.get(t);
                        ...
                        if (3 === arguments.length) {
                            ...
                            if (!u) throw new F("Graph.".concat(o, ':  could not find the "').concat(t, '" source node in the graph.'));
                            if (!this._nodes.has(e)) throw new F("Graph.".concat(o, ':  could not find the "').concat(e, '" target node in the graph.'));
                            return lt(!1, r, this.multi, i, u, e, n);
                        }
                ...
                t.prototype[c] = function() {
                    ...
                    if (n.length < 2 || n.length > 4) throw new B("Graph.".concat(c, ": invalid number of arguments (expecting 2, 3 or 4 and got ").concat(n.length, ")."));
                    if ("function" == typeof n[n.length - 1] && "function" != typeof n[n.length - 2]) throw new B("Graph.".concat(c, ": missing initial value. You must provide it because the callback takes more than one argument and we cannot infer the initial value from the first iteration, as you could with a simple array."));
                ...
                t.prototype[o] = function(t, e, n) {
                    ...
                    if (1 === arguments.length) return st(!0, this, r, n = t);
                    if (2 === arguments.length) {
                        t = "" + t, n = e;
                        var a = this._nodes.get(t);
                        if (void 0 === a) throw new F("Graph.".concat(o, ': could not find the "').concat(t, '" node in the graph.'));
                    ...
                    if (3 === arguments.length) {
                        ...
                        if (!u) throw new F("Graph.".concat(o, ':  could not find the "').concat(t, '" source node in the graph.'));
                        if (!this._nodes.has(e)) throw new F("Graph.".concat(o, ':  could not find the "').concat(e, '" target node in the graph.'));
                        return lt(!0, r, this.multi, i, u, e, n);
                    }
                    throw new B("Graph.".concat(o, ": too many arguments (expecting 1, 2 or 3 and got ").concat(arguments.length, ")."));
                };
                ...
                t.prototype[o] = function(t, e) {
                    if ("mixed" !== r && "mixed" !== this.type && r !== this.type) return j.empty();
                    if (!arguments.length) return dt(this, r);
                    if (1 === arguments.length) {
                        t = "" + t;
                        var n = this._nodes.get(t);
        ...
        wt.forEach(function(e) {
            _t(t, e), function(t, e) {
                ...
                t.prototype[c] = function(t, e, n) {
                    if (arguments.length < 3) throw new B("Graph.".concat(c, ": missing initial value. You must provide it because the callback takes more than one argument and we cannot infer the initial value from the first iteration, as you could with a simple array."));
                    var r = n;
    ...
    function Bt(t) {
        t.from = function(e, n) {
            var r = c({}, e.options, n), i = new t(r);
            return i.import(e), i;
        };
    }
    return Bt(Mt), Bt(Wt), Bt(Pt), Bt(Rt), Bt(Kt), Bt(Tt), Mt.Graph = Mt, Mt.DirectedGraph = Wt, Mt.UndirectedGraph = Pt, Mt.MultiGraph = Rt, Mt.MultiDirectedGraph = Kt, Mt.MultiUndirectedGraph = Tt, Mt.InvalidArgumentsGraphError = B, Mt.NotFoundGraphError = F, Mt.UsageGraphError = I, Mt;
});
...
},{"react-refresh/runtime":"786KC"}]},["1xC6H","8T80n","d0Zf9"], "d0Zf9", "parcelRequire0c52")
